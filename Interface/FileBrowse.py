...
class FileBrowser:
    def __init__(self):
        ...
        self.exitMainMenyButton = tk.Button(text='Головне меню', width=20, font="14px")
        self.exitMainMenyButton.place(x='400', y='550')
    ...
    def show_add_line_dialog(self):
        if self.selected_file:
            ...
            save_button = tk.Button(dialog, text="Зберегти", command=lambda: self.add_line(entry_1.get(), entry_2.get(), dialog))
            save_button.pack()
    ...
    def add_line(self, line_text_1, line_text_2, dialog):
        if line_text_1 and line_text_2:
            ...
            messagebox.showerror("Помилка", "Будь ласка, введіть обидва рядки")
